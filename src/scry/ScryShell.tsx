...
export const ScryShell: FC<{
  ...
  <div className={styles.shell}>
    ...
    <footer className={styles.footer}>
      <span>
        Powered by <a className={styles.attribution} href="https://github.com/element-hq/element-call/tree/main/docs" target="_blank" rel="noreferrer">the elements</a> · <a href="https://github.com/kenalba/scry/tree/signal23" target="_blank" rel="noreferrer">source</a>
